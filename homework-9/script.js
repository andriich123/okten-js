...
block.style.backgroundColor = "#a0dbb0"
block.style.color = "##525954"
...
clonedBlock.innerText = "Lorem ipsum dolor sit amet."

// - Є масив:
//     ['Main','Products','About us','Contacts']
// Зробити ul в середині якої будуть лежати елементи масиву (кожен в своєму li)

const navTitles = ['Main','Products','About us','Contacts']
const ulElement = document.createElement('ul')

const liElements = navTitles.map(li => {
...
const coursesContainer2 = document.createElement('div')
...
for (const course of coursesAndDurationArray) {
    ...
    description.textContent = 'Duration (months): ' + course.monthDuration;

    item.append(heading, description);
    coursesContainer2.appendChild(item);
}

document.body.appendChild(coursesContainer2)
...
for (const simpson of simpsons) {
    ...
    container.innerHTML = `
        ...
        <p> Surname: ${simpson.name}</p>
        <p> Age: ${simpson.name}</p>
        <p> Info: ${simpson.name}</p>
        <p> Photo: <img src="${simpson.photo}" alt="avatar"/></p>
    `
    // Another solution
...
const coursesContainer3 = document.createElement('div')
...
for (const course of coursesArray) {
    ...
    description.append(monthDuration, hourDuration)
    ...
    for (const moduleName of course.modules) {
        ...
        module.innerText = moduleName
        modulesContainer.appendChild(module)
    }

    courseContainer.append(title, description, modulesContainer)
    coursesContainer3.appendChild(courseContainer)
}

document.body.appendChild(coursesContainer3)